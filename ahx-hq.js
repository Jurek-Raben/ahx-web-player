...
/*
  ...
  setAHXChannelPanning(ch, 0...1);  // change the panning for channel 0-3
...
let channelPanning = [0.5, 0.5, 0.5, 0.5];
...
function setAHXChannelPanning(channel, pan) {
  if (channel >= 0 && channel < 4) {
    channelPanning[channel] = Math.max(0.0, Math.min(1.0, pan));
  }
}
...
class AHXWaves {
  ...
  generateWhiteNoise(Len) {
    ...
    const noise = [
      ,
    ];
    const outNoise = [];
    for (let x = 0; x < Len; x++) {
...
class AHXVoice {
  ...
  calcADSR() {
    ...
    this.ADSR.dVolume =
      ((this.Instrument.Envelope.dVolume - this.Instrument.Envelope.aVolume) * 256) / this.ADSR.dFrames;
    this.ADSR.sFrames = this.Instrument.Envelope.sFrames;
    this.ADSR.rFrames = this.Instrument.Envelope.rFrames;
    this.ADSR.rVolume =
      ((this.Instrument.Envelope.rVolume - this.Instrument.Envelope.dVolume) * 256) / this.ADSR.rFrames;
  }
}
  ...
  InitSong(stream) {
      ...
      if ((stream.readByteAt(6) & 0x80) == 0x80 && i == 0) {
        ...
        for (let j = 0; j < this.TrackLength; j++) {
          const Step = {
            ...
            Instrument: ((stream.readByteAt(SBPtr) & 0x3) << 4) | (stream.readByteAt(SBPtr + 1) >> 4),
    ...
    for (let i = 1; i < this.InstrumentNr + 1; i++) {
      ...
      Instrument.FilterSpeed =
        ((stream.readByteAt(SBPtr + 1) >> 3) & 0x1f) | ((stream.readByteAt(SBPtr + 12) >> 2) & 0x20);
...
class AHXPlayer {
  constructor(waves) {
    ...
    this.VibratoTable = [
      ...
      180, 161, 141, 120, 97, 74, 49, 24, 0, -24, -49, -74, -97, -120, -141, -161, -180, -197, -212, -224, -235, -244,
      -250, -253, -255, -253, -250, -244, -235, -224, -212, -197, -180, -161, -141, -120, -97, -74, -49, -24,
    ];

    this.PeriodTable = [
      0x0000, 0x0d60, 0x0ca0, 0x0be8, 0x0b40, 0x0a98, 0x0a00, 0x0970, 0x08e8, 0x0868, 0x07f0, 0x0780, 0x0714, 0x06b0,
      0x0650, 0x05f4, 0x05a0, 0x054c, 0x0500, 0x04b8, 0x0474, 0x0434, 0x03f8, 0x03c0, 0x038a, 0x0358, 0x0328, 0x02fa,
      0x02d0, 0x02a6, 0x0280, 0x025c, 0x023a, 0x021a, 0x01fc, 0x01e0, 0x01c5, 0x01ac, 0x0194, 0x017d, 0x0168, 0x0153,
      0x0140, 0x012e, 0x011d, 0x010d, 0x00fe, 0x00f0, 0x00e2, 0x00d6, 0x00ca, 0x00be, 0x00b4, 0x00aa, 0x00a0, 0x0097,
  ...
  ProcessStep(v) {
    ...
    let Instrument = this.Song.Tracks[this.Song.Positions[this.PosNr].Track[v]][this.NoteNr].Instrument;
    let FX = this.Song.Tracks[this.Song.Positions[this.PosNr].Track[v]][this.NoteNr].FX;
    ...
    if (Instrument) {
      ...
      let SquareLower = this.Voices[v].Instrument.SquareLowerLimit >> (5 - this.Voices[v].WaveLength);
      let SquareUpper = this.Voices[v].Instrument.SquareUpperLimit >> (5 - this.Voices[v].WaveLength);
    ...
    switch (FX) {
      ...
      case 0xc: // Volume
        if (FXParam <= 0x40) this.Voices[v].NoteMaxVolume = FXParam;
          ...
          FXParam -= 0x50;
          if (FXParam <= 0x40) for (let i = 0; i < 4; i++) this.Voices[i].TrackMasterVolume = FXParam;
          else {
            FXParam -= 0xa0 - 0x50;
  ...
  ProcessFrame(v) {
    ...
    if (this.Voices[v].FilterOn && --this.Voices[v].FilterWait <= 0) {
      ...
      let FMax = this.Voices[v].FilterSpeed < 3 ? 5 - this.Voices[v].FilterSpeed : 1;
    ...
    if (this.Voices[v].Waveform == 2 || this.Voices[v].PlantSquare) {
      let SquarePtr = this.Waves.FilterSets[toSixtyTwo(this.Voices[v].FilterPos - 1)].Squares;
      let SquareOfs = 0;
    ...
    if (this.Voices[v].NewWaveform) {
      if (this.Voices[v].Waveform != 2) {
        ...
        if (this.Voices[v].Waveform == 3) {
          ...
          this.Voices[v].AudioSource = map[this.Voices[v].WaveLength] ? map[this.Voices[v].WaveLength].slice() : [];
    ...
    this.Voices[v].AudioVolume =
      ((((((((this.Voices[v].ADSRVolume >> 8) * this.Voices[v].NoteMaxVolume) >> 6) * this.Voices[v].PerfSubVolume) >>
        6) *
      ...
      case 6:
        if (FXParam > 0x40) {
          if ((FXParam -= 0x50) >= 0) {
            ...
            else if ((FXParam -= 0xa0 - 0x50) >= 0) if (FXParam <= 0x40) this.Voices[v].TrackMasterVolume = FXParam;
          }
...
class AHXOutput {
  ...
  Init(Frequency) {
    ...
    this.MixingBufferL = new Array(this.BufferSize).fill(0);
    this.MixingBufferR = new Array(this.BufferSize).fill(0);
  }
  ...
  MixChunk(NrSamples, mb) {
    for (let v = 0; v < 4; v++) {
      ...
      // Panning-Werte berechnen: Bei 0.5 sind beide 1.0 (volle Mono-Lautstärke)
      const panL = Math.min(1.0, 2.0 * (1.0 - channelPanning[v]));
      const panR = Math.min(1.0, 2.0 * channelPanning[v]);

      while (samples_to_mix) {
        if (this.pos[v] >= 0x280 << 16) this.pos[v] -= 0x280 << 16;
        const thiscount = Math.min(samples_to_mix, Math.floor(((0x280 << 16) - this.pos[v] - 1) / delta) + 1);
        ...
        if (useOversampling) {
          for (let i = 0; i < thiscount; i++) {
            ...
            const mixed_vol = ((smp * this.Player.Voices[v].VoiceVolume) >> 6) * masterVolume;

            this.MixingBufferL[mb + mixpos] += mixed_vol * panL;
            this.MixingBufferR[mb + mixpos] += mixed_vol * panR;
            mixpos++;
            this.pos[v] += delta;
          }
        } else {
          for (let i = 0; i < thiscount; i++) {
            const mixed_vol =
              ((this.Player.Voices[v].VoiceBuffer[this.pos[v] >> 16] * this.Player.Voices[v].VoiceVolume) >> 6) *
              masterVolume;
  ...
  MixBuffer() {
    this.MixingBufferL.fill(0);
    this.MixingBufferR.fill(0);
    let mb = 0;
...
class AHXMasterBase {
  ...
  Play(song) {
    ...
    this.AudioNode = this.AudioContext.createScriptProcessor(this.bufferSize, 0, 2);
  ...
  mixer(e) {
    ...
    while (want > 0) {
      ...
      want -= can;
      while (can-- > 0) {
        // Zuweisung auf den linken und rechten Audio-Kanal
        left[out] = this.Output.MixingBufferL[this.bufferOffset] / (128 * 4);
        right[out] = this.Output.MixingBufferR[this.bufferOffset] / (128 * 4);
        this.bufferOffset++;
        out++;
      }
...
export { AHXMasterBase as AHXMaster, AHXSong, setAHXMasterVolume, setAHXOversampling, setAHXChannelPanning };

  ...
  return {
    ...
    ProcessStep: function (v) {
      ...
      if (Instrument) {
        ...
        //InitHardCut
        this.Voices[v].HardCutRelease =
          this.Voices[v].Instrument.HardCutRelease;
    ...
    ProcessFrame: function (v) {
      ...
      if (this.Voices[v].VibratoDepth) {
        if (this.Voices[v].VibratoDelay <= 0) {
          ...
          this.Voices[v].VibratoCurrent =
            (this.Voices[v].VibratoCurrent + this.Voices[v].VibratoSpeed) &
            0x3f;
      ...
      if (
        ...
        if (--this.Voices[v].PerfWait <= 0) {
          ...
          if (this.Voices[v].PerfList.Entries[Cur].Note) {
            ...
            this.Voices[v].PlantPeriod = 1;
            this.Voices[v].FixedNote =
              this.Voices[v].PerfList.Entries[Cur].Fixed;
          }
        }
      } else {
      ...
      if (this.Voices[v].PeriodPerfSlideOn) {
        ...
        if (this.Voices[v].PeriodPerfSlidePeriod)
          this.Voices[v].PlantPeriod = 1;
      }
      ...
      if (this.Voices[v].Waveform == 3 - 1 || this.Voices[v].PlantSquare) {
        //CalcSquare
        var SquarePtr =
          this.Waves.FilterSets[toSixtyTwo(this.Voices[v].FilterPos - 1)]
            .Squares;
        var SquareOfs = 0;
        ...
        if (this.Voices[v].Waveform != 3 - 1) {
          ...
          if (this.Voices[v].Waveform == 4 - 1) {
            ...
            switch (this.Voices[v].WaveLength) {
              case 0:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Triangle04.slice();
                break;
              case 1:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Triangle08.slice();
                break;
              case 2:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Triangle10.slice();
                break;
              case 3:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Triangle20.slice();
                break;
              case 4:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Triangle40.slice();
                break;
              case 5:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Triangle80.slice();
                break;
            }
            ...
            switch (this.Voices[v].WaveLength) {
              case 0:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Sawtooth04.slice();
                break;
              case 1:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Sawtooth08.slice();
                break;
              case 2:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Sawtooth10.slice();
                break;
              case 3:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Sawtooth20.slice();
                break;
              case 4:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Sawtooth40.slice();
                break;
              case 5:
                this.Voices[v].AudioSource =
                  this.Waves.FilterSets[FilterSet].Sawtooth80.slice();
                break;
            }
          }
        }
      ...
      switch (FX) {
        ...
        case 3: // Init Square Modulation
          if (!this.Voices[v].IgnoreSquare) {
            this.Voices[v].SquarePos =
              FXParam >> (5 - this.Voices[v].WaveLength);
...
function AHXMasterMoz(output) {
  ...
  this.Play = function (song) {
    ...
    this.audioDestination = new AudioDataDestination(this.sampleRate, function (
      s,
    ) {
      theMaster.mixer(s);
    });
...
function dataType() {
  ...
  this.readStringAt = function (atPos) {
    ...
    while (1) {
      if (
        this.data[atPos] != undefined &&
        this.data[atPos++].charCodeAt(0) != 0
      )
